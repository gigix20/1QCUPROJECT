...
switch ($resource) {
  ...
  case 'report_by_department': 
    $controller->exportAssetByDepartment();   
    break;

  case 'report_certified':     $controller->exportCertifiedAssets();     
  break;
  ...
  case 'report_borrowing':     
    $controller->exportBorrowingActivity();   break;
  case 'report_utilization':   $controller->exportAssetUtilization();    
  break;
