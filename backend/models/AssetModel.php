...
class AssetModel {
  ...
  public function getAllAssets() {
    $sql = "SELECT a.asset_id, a.qr_code, a.description, a.serial_number,
                   c.category_name, d.department_name, a.location,
                   a.status, a.is_certified, a.created_at, a.updated_at
            FROM   tbl_assets a
  ...
  public function getAssetById($asset_id) {
    $sql = "SELECT a.asset_id, a.qr_code, a.description, a.serial_number,
                   a.category_id, c.category_name, a.department_id,
                   d.department_name, a.location, a.status,
                   a.is_certified, a.created_at, a.updated_at
            FROM   tbl_assets a
            LEFT JOIN tbl_categories  c ON a.category_id  = c.category_id
            LEFT JOIN tbl_departments d ON a.department_id = d.department_id
  ...
  public function addAsset($data) {
    $sql = "INSERT INTO tbl_assets (
              ...
              status, is_certified, created_at, updated_at
            ) VALUES (
              :asset_id, :qr_code, :description, :serial_number,
              :category_id, :department_id, :location,
              :status, :is_certified, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
            )";
