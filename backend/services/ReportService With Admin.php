...
class ReportService {
  ...
  // REPORT 2: ASSET BY DEPARTMENT REPORT
  ...
  // REPORT 3: CERTIFIED ASSETS REPORT
  ...
  // REPORT 5: BORROWING ACTIVITY REPORT
  ...
  // REPORT 6: ASSET UTILIZATION REPORT
